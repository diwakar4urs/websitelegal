    ...
    function wbc_extended_example( $demo_active_import , $demo_directory_path ) {
        ...
        */
        ...
        if ( class_exists( 'RevSlider' ) ) {
            $wbc_sliders_array = array(
                ...
                'Home Decentralized Coin' => array(
                    'image-hero31.zip'
                ),
                'Home One Page' => array(
                    'image-hero31.zip'
                ),
                'Home Decentralized SVG' => array(
                    'image-hero31.zip'
                ),
        ...
        *************************************************************************/
        ...
        $wbc_menu_array = array( 
            ...
            'Home Crypto ICO',
            'Home Crypto Stats',
            'Home Decentralized Coin',
            'Home One Page',
            'Home Decentralized SVG',
            'Home ICO Consultant',
        ...
        */
        ...
        $wbc_home_pages = array(
            ...
            'Home Decentralized Coin'                 => 'Home Decentralized Coin',
            'Home One Page'                 => 'Home One Page',
            'Home Decentralized SVG'                 => 'Home Decentralized SVG',
